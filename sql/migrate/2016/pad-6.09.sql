...
where db_versie = '6.09';

--------------------------------------------------------------------;
-- UP
--------------------------------------------------------------------;

select dos2.id, dos2.dossier_id, dos2.PROGRAMMA_CODE,
...
where dos2.id in (
		...
		where 1 = 1
		    and dos.DOSSIER_ID not like '+_%' escape '+'
...
insert into art46.db_versie(db_versie) values ('6.09');
