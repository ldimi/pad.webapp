...
be.bestek_id,
be.bestek_nr,
case when dos.raamcontract_jn = 'J' then be.bestek_hdr_id else dos.doss_hdr_id end as bestek_hdr_id,
be.dossier_id,
dos.dossier_nr,
be.dossier_type,
dos.dossier_b,
...
be.meetstaat_excel_brief_id,
be.controle_dms_id,
be.controle_dms_filename,
be.controle_dms_folder,
be.voorstellen_opm
from art46.bestek be
inner join art46.v_dossier dos on be.dossier_id = dos.id
inner join art46.bestek_type bt on be.type_id = bt.type_id
...
insert into art46.db_versie(db_versie, omschrijving) values ('6.36', 'bijkomende velden v_bestek');
