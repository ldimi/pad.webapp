...
alter table art46.bestek
    add column voorstellen_opm varchar(250);
;
...
insert into art46.db_versie(db_versie, omschrijving) values ('6.30', 'toevoegen bestek.voorstellen_opm');
