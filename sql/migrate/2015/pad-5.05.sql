...
-- herdefinieren van dependend views
-- -----------------------------------;
...
-- offerte gegevens meenemen in view van deelopdracht
-- --------------------------------------------------;
...
-- veld excl_btw_bedrag  toevoegen aan v_schuldvordering
----------------------------------------------------------;
...
insert into art46.db_versie(db_versie) values ('5.05');
