...
where db_versie = '5.21';

--------------------------------------------------------------------;
-- UP
--------------------------------------------------------------------;

alter table art46.BESTEK alter column BESTEK_ID set generated by default as identity (
START WITH 1706);


-- verwijderen van     be.raamcontract_s  uit view
...
insert into art46.db_versie(db_versie) values ('5.21');
