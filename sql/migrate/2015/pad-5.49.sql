...
alter table art46.bestek
    add column screening_organisatie_id int
;

call sysproc.admin_cmd('reorg table art46.bestek');

alter table art46.bestek
    add constraint cc_screening check (
          (screening_jn = 'J' and screening_organisatie_id is not null) OR
          (screening_jn = 'N' and screening_organisatie_id is null)
    )
;
...
insert into art46.db_versie(db_versie) values ('5.49');
