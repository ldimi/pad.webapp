...
drop table art46.dossier_doelgroep_type;

delete from  art46.db_versie
where db_versie = '5.28.a';
...
create table art46.dossier_doelgroep_type
(
    doelgroep_type_id  int not null generated by default as identity (START WITH 1),
    doelgroep_type_b  varchar(50) not null,
    primary key (doelgroep_type_id)
)
;

alter table art46.dossier
    add column doelgroep_type_id  int
;

alter table art46.dossier
    add foreign key fk_dos_doelgroep (doelgroep_type_id)
         references art46.dossier_doelgroep_type (doelgroep_type_id)
         on delete restrict;
...
from art46.dossier dos
        ...
        left join art46.dossier_doelgroep_type doelgr on dos.doelgroep_type_id = doelgr.doelgroep_type_id
;
...
insert into art46.dossier_doelgroep_type
(doelgroep_type_b)
values
('particulieren'),
('bedrijven'),
('lokale en bovenlokale besturen'),
('publieke overheden'),
('andere')
;
...
insert into art46.db_versie(db_versie) values ('5.28.a');
