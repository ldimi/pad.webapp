...
CREATE TABLE ART46.PLANNING_ACTIE
(
    ACTIE_CODE VARCHAR(5) not null,
    ACTIE_CODE_B VARCHAR(20),
    creatie_ts timestamp default '1990-01-01' not null,
    wijzig_ts timestamp default '1990-01-01' not null,
    PRIMARY KEY (ACTIE_CODE)
);
...
(
   ...
   FOREIGN KEY FK_PLLV_ACTIE (ACTIE_CODE)
           REFERENCES ART46.PLANNING_ACTIE (ACTIE_CODE) ON DELETE RESTRICT,
...
insert into ART46.DB_VERSIE(DB_VERSIE) values ('3.02.22');
