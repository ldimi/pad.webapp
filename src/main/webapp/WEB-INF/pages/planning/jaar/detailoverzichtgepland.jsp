...
<div style="border: 1px solid;
    ...
    <div style="padding-top: 5px;">
        <form:form modelAttribute="params" action="s/planning/jaar/detailoverzicht/gepland/zoek" method="GET">
            <div>
                ...
                <form:select path="deelopdracht_jn"  class="input">
                    <form:option value="N">enkel vastleggingen</form:option>
                    <form:option value="J">enkel deelopdrachten</form:option>
                </form:select>
            </div>
            <div style="padding-top: 5px;" >
                gepland van :
                <form:input path="gepland_van_d" id=""/>
                tot :
                <form:input path="gepland_tot_d" id=""/>
    ...
    <div>
        <display:table id="detailOverzichtTable" name="requestScope.detailoverzichtLijst" export="true" requestURI="s/planning/jaar/detailoverzicht/gepland/zoek" defaultsort="1"
            ...
            <display:column title="deelopdr ?" headerClass="header_gepland" sortable="true" property="deelopdracht_jn" />
            ...
            <display:column title="Gepland bedrag" headerClass="header_gepland" sortable="true" property="ig_bedrag" class="number" decorator="be.ovam.art46.decorator.CurrencyDecorator" />
