...
<script>
    function reloadform(){
        ...
        setAction(form,'/pad/s/bestek/${bestekDO.bestek_id}/acties/${actieId}/wijzig/');
        form.submit();
    }

</script>

<form:form action="/pad/s/bestek/${bestekDO.bestek_id}/acties/${actieId}/bewaar/" name="formActie">
    ...
    <table bgcolor="#eeeeee">
        ...
        <tr>
            <td colspan='2' align='right'>
                <input type="button" value="Venster sluiten" name="dummy" onclick="pad_load('/pad/s/bestek/${bestekDO.bestek_id}/acties/', top.opener)" class="inputbtn" />
