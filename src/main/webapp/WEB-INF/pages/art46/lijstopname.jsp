...
<%	String styleclass = "center"; %>
<logic:equal name="art46selectform" property="forward" scope="session" value="kadaster">
    <body onload='sumdossier(new Array("sumog","sumig"), new Array("lijstopname","lijstopname"), new Array(5,6));sumkadaster(new Array("sumogk","sumigk"), new Array("lijstopname","lijstopname"), new Array(5,6))'>
</logic:equal>
<logic:equal name="art46selectform" property="forward" scope="session" value="dossier">
    <body onload='sumdossier(new Array("sumog","sumig"), new Array("lijstopname","lijstopname"), new Array(4,5))'>
</logic:equal>
<table cellpadding='0' cellspacing='0' bgcolor="#eeeeee">
    <html:form action="lijstopnameselect" method="get">
    <tr valign='middle'>
        <td valign='middle'>
...
<html:form action="dummyAction2">

    <html:hidden property="artikelid" />
    <html:hidden property="goedkeuring_s" value="1" />
    <html:hidden property="nextpage" value="lijstopname" />

    <display:table class="lijst"  htmlId="lijstopname"  id="dossierkadaster"  name="sessionScope.lijst" requestURI="/lijstopnameview.do" export="true" pagesize='<%= ((be.ovam.art46.struts.actionform.PagingForm) session.getAttribute("pagingform")).getPagesizeInt()%>' defaultsort="1">
        <logic:equal name="art46selectform" property="forward" scope="session" value="kadaster">
        ...
        <display:column class="center" title="Opmerking" property="commentaar_dossier" maxLength="50" media="html"/>
        ...
        <display:setProperty name="paging.banner.onepage" value="test"/>
    </display:table>
    <logic:equal name="art46selectform" property="forward" scope="session" value="kadaster">
        <logic:notEqual name="art46selectform" property="artikelid" value='-1'>
            <logic:present role="adminArt46,adminIVS,adminBOA">
                <html:submit styleClass="inputbtn" value=" << " onclick="setAction(this.form,'removedossierkadasters.do')" title="Percelen verwijderen van de lijst opname"/>
            </logic:present>
            <logic:present role="adminArt46">
                <input type="button" value="Alle percelen selecteren" onClick="checkAll(document.setdateform.dossierkadasters)" class="inputbtn"/>
            </logic:present>
            <logic:present role="adminArt46">
                <html:submit styleClass="inputbtn" value=" >> " title="Percelen toevoegen aan de lijst voorstel" onclick="setAction(this.form,'updatedossierkadasters.do')"/>
            </logic:present>
        </logic:notEqual>
    </logic:equal>
