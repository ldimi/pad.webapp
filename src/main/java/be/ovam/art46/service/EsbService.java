...
public interface EsbService {
    ...
    byte[] getDocumentAsStreamByte(String alfrescoUserId, String noderef);
    
    void convertToPDF(File odtFile, File pdfFile) throws Exception;

    boolean print(String dms_id, String user_id, String nummer);

    String getNodeRefFor(String path, String bestandsnaam, String uid);
