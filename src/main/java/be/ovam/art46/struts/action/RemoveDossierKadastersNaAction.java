...
/**
 * Action om records uit de tabel RS.ART46_NA_GOEDK te verwijderen.  Records worden verwijdert via de methode {@link be.ovam.art46.dao.DossierKadasterDAO#deleteDossierKadasterNG deleteDossierKadasterNG()}. 
 * 
 * @author Tonny Bruckers
 * @version 0.1 (2004/04/24)
 */

public class RemoveDossierKadastersNaAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, ActionErrors errors) throws Exception {
		dao.deleteDossierKadasterNG(request.getParameterValues("dossierkadasters"), ((Art46BaseForm) form).getLijst_id());
		return null;
	}
