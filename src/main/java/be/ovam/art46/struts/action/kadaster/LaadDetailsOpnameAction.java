...
public class LaadDetailsOpnameAction  extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse respons) throws Exception {
		...
		List opnameLijst = sqlSession.selectList("be.ovam.art46.mappers.KadasterMapper.getDetailsOpnameLijst", dossierkadastersform.getKadaster_id());
		request.setAttribute("kadasterdetailsopname", opnameLijst);
