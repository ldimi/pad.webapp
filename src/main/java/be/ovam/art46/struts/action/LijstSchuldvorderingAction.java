...
public class LijstSchuldvorderingAction extends ZoekAction {
	...
	public Object fecthResult(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return sqlSession.selectList("be.ovam.art46.mappers.SchuldvorderingMapper.getLijstSchuldvordering", form);
	}
}
