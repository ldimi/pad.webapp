...
public class AdresForm extends CrudActionForm {
	...
	private String[] persoonIds;
	private String referentie_postcodes;
	
	public String[] getPersoonIds() {
		return persoonIds;
	}

	public void setPersoonIds(String[] persoonIds) {
	...
	public Serializable getCrudId() {
		return Integer.valueOf(adres_id);
	}
